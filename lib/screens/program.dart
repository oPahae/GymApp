...
class _ProgramScreenState extends State<ProgramScreen> {
  ...
  // Récupérer l'ID du client (à adapter selon ton auth system)
  int get _clientId => 1; // Remplace par l'ID réel du client connecté
  ...
  Future<List<DayProgram>> _fetchProgram() async {
    try {
      ...
      // En cas d'erreur, retourner les données fake
      return [];
    } catch (e) {
  ...
  FoodType _parseFoodType(String? type) {
    switch (type?.toLowerCase()) {
      case 'liquid': return FoodType.liquid;
      case 'solid': return FoodType.solid;
      case 'grains': return FoodType.grains;
      case 'unit': return FoodType.unit;
      default: return FoodType.solid;
    }
  }
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: isSelected ? kNeonGreen : hasData ? Colors.white24 : Colors.white10,
              ...
              child: Column(
                ...
                children: [
                  Text(_daysShort[index],
                    style: TextStyle(
                      color: isSelected ? kNeonGreen : hasData ? Colors.white : Colors.white38,
                      fontSize: 11,

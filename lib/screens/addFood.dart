...
class _AddFoodScreenState extends State<AddFoodScreen>
  ...
  List<FoodModel> get _filteredRecent =>
      kRecentFoods.where((f) => f.name.toLowerCase().contains(_searchQuery)).toList();
      ...
      child: Row(
        children: [
          ...
          Padding(
            ...
            child: qty == 0
                ? _buildAddBtn(() => _addToCart(food.id))
                : _buildQtyControl(qty, () => _addToCart(food.id),
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        qty == 0
                            ? _buildAddBtn(() => _addToCart(recipe.id))
                            : _buildQtyControl(
                                qty,
                                () => _addToCart(recipe.id),
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(8),
              border:
                  Border.all(color: kNeonGreen.withOpacity(0.45), width: 1),
            ),
